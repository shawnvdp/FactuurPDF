...
async function getAllInvoices() {
  const invoices = await query("SELECT * FROM invoice ORDER BY invoiceNumber");
  return invoices;
}
...
module.exports = { query, updateInvoice, addInvoiceToDb, getInvoiceByNumber, getInvoiceMaterialsByNumber, getAllInvoices };